...
#define AMOUNT_INSTR 28
int byteCodeStatistics[AMOUNT_INSTR];

#define STACKSIZE 1000
  
void prettyPrintInstruction(int instr) {
  switch (instr) {
  case CSTI:   printf("CSTI"); break;
  ...
  case INCSP:  printf("INCSP"); break;
  case GOTO:   printf("GOTO"); break;
  case IFZERO: printf("IFZERO"); break;
  case IFNZRO: printf("IFNZRO"); break;
